...
SRC_URI="
	amd64? (
		https://downloads2.saleae.com/logic2/${APPIMAGE}
	)
"
...
src_prepare() {
	...
	pushd resources/linux-x64/Analyzers >/dev/null || die
	for f in *.so; do
...
src_install() {
	...
	fperms 4711 /opt/Logic/chrome-sandbox
	fperms +x /opt/Logic/Logic
