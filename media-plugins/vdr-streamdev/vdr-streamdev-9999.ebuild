# Copyright 1999-2021 Paul Zander
...
EGIT_REPO_URI="git://projects.vdr-developer.org/vdr-plugin-streamdev.git"
...
src_install() {
	...
	if use server; then
		...
		doconfd "${FILESDIR}"/confd-0.6.0 vdr.streamdev-server
