...
# 	cmake_run_in tests cmake_comment_add_subdirectory osl
	...
	# https://github.com/AcademySoftwareFoundation/OpenColorIO/issues/2129
	sed -e '/OIIO_RECOMMENDED_VERSION/s/2\.4/3.0/' -i share/cmake/modules/FindExtPackages.cmake || die
}
