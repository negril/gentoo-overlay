...
LICENSE="BSD"
SLOT="0/$(ver_cut 1-2)"
IUSE="doc examples +gdk-pixbuf gif jpeg openexr +png tcmalloc test"
...
DEPEND="
	...
	tcmalloc? ( dev-util/google-perftools:=[${MULTILIB_USEDEP}] )
"
RDEPEND="
	${DEPEND}
...
multilib_src_configure() {
	local mycmakeargs=(
		...
		-DCMAKE_DISABLE_FIND_PACKAGE_benchmark="yes"
		# "$(cmake_use_find_package benchmark)"
		"$(cmake_use_find_package gif GIF)"
		"$(cmake_use_find_package jpeg JPEG)"
		"$(cmake_use_find_package png PNG)"

		# Only relevant for JPEGXL_FORCE_SYSTEM_HWY="yes"
		...
		-DJPEGXL_ENABLE_VIEWERS=OFF # $(usex tools) # Qt6 ecm
		-DJPEGXL_FORCE_SYSTEM_BROTLI=ON
		-DJPEGXL_FORCE_SYSTEM_GTEST=ON
		-DJPEGXL_FORCE_SYSTEM_HWY=ON
		-DJPEGXL_FORCE_SYSTEM_LCMS2=ON
		-DJPEGXL_ENABLE_DOXYGEN="$(usex doc)"
		-DSPHINX_BUILD_PROGRAM="NOTFOUND"
		-DJPEGXL_ENABLE_MANPAGES="yes"
