...
if [[ "${PV}" == *9999* ]]; then
	...
	SRC_URI="
		https://github.com/PixarAnimationStudios/USD/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	"
...
src_configure() {
	...
	local mycmakeargs+=(
		...
		-DPXR_BUILD_PYTHON_DOCUMENTATION=$(usex man $(usex python))
		...
		-DPXR_ENABLE_VULKAN_SUPPORT=$(usex vulkan)
