...
REQUIRED_USE="
	?? ( optimize tbb )
	|| ( opengl gles2 )
	test? ( freeimage json opengl tk truetype X )
	vtk? ( X )
"
...
src_configure() {
	...
	local mycmakeargs=(
		...
		# adm/qmake/Occt.pro
		# src/OS/FILES -> srcinc -> :depends

		# TTool                        FoundationClasses Draw ApplicationFramework DataExchange ModelingData Visualization
		# Draw                         DataExchange
# 52:proc Draw:acdepends { } { return [list TCLTK] }

		# DataExchange                 ApplicationFramework
		# ApplicationFramework         Visualization
		# Visualization                ModelingAlgorithms
# 61:proc Visualization:acdepends { } {
# 62-    set aList [list X11 GL FREETYPE]

		# ModelingAlgorithms           ModelingData
		# ModelingData                 FoundationClasses
		# FoundationClasses

# 		-DBUILD_MODULE_DETools="no"
# 		-DBUILD_MODULE_Draw="no"
# 		-DBUILD_MODULE_DataExchange="no"
# 		-DBUILD_MODULE_ApplicationFramework="no"
# 		-DBUILD_MODULE_Visualization="yes"
# 		-DBUILD_MODULE_ModelingAlgorithms="yes"
# 		-DBUILD_MODULE_ModelingData="yes"
# 		-DBUILD_MODULE_FoundationClasses="yes"
