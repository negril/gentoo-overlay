...
LICENSE="BSD"
SLOT="0/$(ver_cut 1-2)"
IUSE="apps cuda doc examples opengl openni openni2 pcap png +qhull qt6 usb vtk cpu_flags_x86_sse test tutorials"
...
# 		-DBUILD_cuda_apps="$(usex cuda $(usex apps))"
# 		-DBUILD_cuda_io="$(usex cuda $(usex openni))"
