...
src_configure() {
	# TODO BUG
	# /var/tmp/paludis/media-gfx-netgen-6.2.2601/work/netgen-6.2.2601/libsrc/core/simd_sse.hpp: In member function ‘int64_t ngcore::SIMD<long int, 2>::Lo() const’:
	# /var/tmp/paludis/media-gfx-netgen-6.2.2601/work/netgen-6.2.2601/libsrc/core/simd_sse.hpp:74:48: error: dereferencing type-punned pointer will break strict-aliasing rules [-Werror=strict-aliasing]
